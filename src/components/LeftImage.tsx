...
export default function LeftImg({title, content_a, color, src, bg_src, content_b}: Desc) {
    return (
            ...
            <div className='mx-auto my-4 flex flex-col lg:w-1/2 md:w-1/2 w-[80%] justify-around gap-2'>
                <div className=' flex flex-col gap-8 lg:mt-0 mt-4'>
                    ...
                    <div className="flex flex-col gap-3">
                        <p className={`lg:w-[96%] w-full font-extralight text-base`} style={{ fontFamily: "'Manrope', sans-serif", whiteSpace: "pre-line" }}>{content_a}</p>
                        <p className={`lg:w-[96%] w-full font-extralight text-base`} style={{ fontFamily: "'Manrope', sans-serif", whiteSpace: "pre-line" }}>{content_b}</p>
                    </div>
                </div>
            </div>
        </section>
