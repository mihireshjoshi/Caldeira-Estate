...
export default function LandingHero() {
    return (
        <section>
            ...
            <div
                className="hero bg-cover bg-center min-h-screen mx-auto pt-8 pb-12 flex flex-col justify-between"
